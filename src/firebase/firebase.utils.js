  ...
  if (!snapShot.exists) {
    ...
    if (displayName) {
      var welcomeNote = {
        ...
        text: `<p>We are excited that you've chosen <strong><em>UNCLTR</em></strong> to journal your genius thoughts!</p><p><br></p><p>Here's just a few things to know before you get started:</p><p><strong>Quick tips:</strong></p><p>-- Your notes are safe and secure on your account, and you can access them from any platform (at <a href="https://uncltr-notes.web.app/" rel="noopener noreferrer" target="_blank"><strong><em>uncltr-notes.web.app</em></strong></a>)</p><p>-- Styles and formatting are saved as well</p><p>-- To create a new button, simply click on the "Add-note" icon in the notes column</p><p>-- Similarly, you can delete any note by clicking on the "trash can" icon beside it</p><p>-- You can also easily search for notes by the title, text or date of last edit by typing in the search bar</p><p>-- Finally, the world (this quill, really) is your oyster... go crazy!</p>`,
